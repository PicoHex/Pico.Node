...
public sealed class HttpContractTests
{
    ...
    public async Task HttpConnectionHandlerOptions_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.GetProperty(nameof(HttpConnectionHandlerOptions.RequestHandler))?.PropertyType)
            .IsEqualTo(typeof(HttpRequestHandler));
        await Assert.That(type.GetProperty(nameof(HttpConnectionHandlerOptions.ServerHeader))?.PropertyType)
            .IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpConnectionHandlerOptions.MaxRequestBytes))?.PropertyType)
    ...
    {
        var invoke = typeof(HttpRequestHandler).GetMethod("Invoke", BindingFlags.Public | BindingFlags.Instance);
        ...
        await Assert.That(invoke?.GetParameters().Select(x => x.ParameterType).ToArray())
    ...
    public async Task HttpRequest_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.IsSealed).IsTrue();
        await Assert.That(properties.Select(x => x.Name).ToArray())
            .IsEquivalentTo(
                [
        ...
        await Assert.That(type.GetProperty(nameof(HttpRequest.Method))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpRequest.Target))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpRequest.Version))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpRequest.HeaderFields))?.PropertyType)
            .IsEqualTo(typeof(IReadOnlyList<KeyValuePair<string, string>>));
        await Assert.That(type.GetProperty(nameof(HttpRequest.Headers))?.PropertyType)
            .IsEqualTo(typeof(IReadOnlyDictionary<string, string>));
        await Assert.That(type.GetProperty(nameof(HttpRequest.Body))?.PropertyType)
    ...
    public async Task HttpResponse_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.GetProperty(nameof(HttpResponse.StatusCode))?.PropertyType).IsEqualTo(typeof(int));
        await Assert.That(type.GetProperty(nameof(HttpResponse.ReasonPhrase))?.PropertyType)
            .IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpResponse.Version))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpResponse.Headers))?.PropertyType)
            .IsEqualTo(typeof(IReadOnlyList<KeyValuePair<string, string>>));
        await Assert.That(type.GetProperty(nameof(HttpResponse.Body))?.PropertyType)
            .IsEqualTo(typeof(ReadOnlyMemory<byte>));
    }
    ...
    public async Task HttpRoute_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.GetProperty(nameof(HttpRoute.Method))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpRoute.Path))?.PropertyType).IsEqualTo(typeof(string));
        await Assert.That(type.GetProperty(nameof(HttpRoute.Handler))?.PropertyType)
            .IsEqualTo(typeof(HttpRequestHandler));
    }
    ...
    public async Task HttpRouterOptions_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.GetProperty(nameof(HttpRouterOptions.Routes))?.PropertyType)
            .IsEqualTo(typeof(IReadOnlyList<HttpRoute>));
        await Assert.That(type.GetProperty(nameof(HttpRouterOptions.FallbackHandler))?.PropertyType)
            .IsEqualTo(typeof(HttpRequestHandler));
    }
    ...
    public async Task HttpRouter_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(methods.Select(x => x.Name).ToArray())
            .IsEquivalentTo([nameof(HttpRouter.HandleAsync)]);
        await Assert.That(type.GetMethod(nameof(HttpRouter.HandleAsync))?.ReturnType)
    ...
    public async Task HttpConnectionHandler_exposes_expected_contract_shape()
    {
        ...
        await Assert.That(type.GetMethod(nameof(HttpConnectionHandler.OnConnectedAsync))?.ReturnType)
            .IsEqualTo(typeof(Task));
        await Assert.That(type.GetMethod(nameof(HttpConnectionHandler.OnReceivedAsync))?.ReturnType)
            .IsEqualTo(typeof(ValueTask<SequencePosition>));
        await Assert.That(type.GetMethod(nameof(HttpConnectionHandler.OnClosedAsync))?.ReturnType)
            .IsEqualTo(typeof(Task));
    }
}
